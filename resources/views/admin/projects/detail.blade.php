            ...
            <div class="card d-block">
                <div class="card-body">
                    ...
                    <div id="tooltips-container">
                        <h5>Team Members:</h5>
                        <a href="javascript:void(0);" data-bs-container="#tooltips-container" data-bs-toggle="tooltip"
                    ...
                    <div class="mt-2">
                        <div class="d-flex align-items-start">
                            <img class="me-2 avatar-sm rounded-circle"
                                 src="{{ asset('storage/assets/images/users/avatar-3.jpg') }}"
                                 alt="Generic placeholder image">
                            <div class="w-100">
                                <h5 class="mt-0"><a href="contacts-profile.html" class="text-reset">Jeremy Tomlinson</a>
                                    <small class="text-muted">3 hours ago</small></h5>
                        ...
                        <div class="d-flex align-items-start mt-3">
                            <img class="me-2 avatar-sm rounded-circle"
                                 src="{{ asset('storage/assets/images/users/avatar-2.jpg') }}"
                                 alt="Generic placeholder image">
                            <div class="w-100">
                                <h5 class="mt-0"><a href="contacts-profile.html" class="text-reset">Jonathan Tiner</a>
                                    <small class="text-muted">1 day ago</small></h5>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col ps-0">
                                    <a href="javascript:void(0);"
                                       class="text-muted fw-bold">TechUI-sketch-design.zip</a>
