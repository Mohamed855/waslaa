                ...
                <div class="card-body">
                    ...
                    <div class="avatar-group mb-3" id="tooltips-container">
                        <a href="javascript: void(0);" class="avatar-group-item">
                            <img src="{{ asset('storage/assets/images/users/avatar-1.jpg') }}"
                                 class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container"
                                 data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mat Helme"/>
                        </a>

                        <a href="javascript: void(0);" class="avatar-group-item">
                            <img src="{{ asset('storage/assets/images/users/avatar-2.jpg') }}"
                                 class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container"
                                 data-bs-toggle="tooltip" data-bs-placement="bottom" title="Michael Zenaty"/>
                        </a>

                        <a href="javascript: void(0);" class="avatar-group-item">
                            <img src="{{ asset('storage/assets/images/users/avatar-3.jpg') }}"
                                 class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container"
                                 data-bs-toggle="tooltip" data-bs-placement="bottom" title="James Anderson"/>
                        </a>

                        <a href="javascript: void(0);" class="avatar-group-item">
                            <img src="{{ asset('storage/assets/images/users/avatar-4.jpg') }}"
                                 class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container"
                                 data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mat Helme"/>
                        </a>

                        <a href="javascript: void(0);" class="avatar-group-item">
                            <img src="{{ asset('storage/assets/images/users/avatar-5.jpg') }}"
                                 class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container"
                                 data-bs-toggle="tooltip" data-bs-placement="bottom" title="Username"/>
                        </a>
                    </div>
                    <!-- Progress-->
        ...
        <div class="col-lg-4">
            <div class="card project-box">
                <div class="card-body">
                    ...
                    <!-- Desc-->
                    <p class="text-muted font-13 mb-3 sp-line-2">A handful of model sentence structures, to generate
                        Lorem Ipsum which looks reasonable...<a href="javascript:void(0);" class="fw-bold text-muted">view
                            more</a>
                    </p>
                    <!-- Task info-->
                    <p class="mb-1">
                    ...
                    <div class="avatar-group mb-3" id="tooltips-container1">
                        <a href="javascript: void(0);" class="avatar-group-item">
                            <img src="{{ asset('storage/assets/images/users/avatar-6.jpg') }}"
                                 class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container1"
                                 data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mat Helme"/>
                        </a>

                        <a href="javascript: void(0);" class="avatar-group-item">
                            <img src="{{ asset('storage/assets/images/users/avatar-7.jpg') }}"
                                 class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container1"
                                 data-bs-toggle="tooltip" data-bs-placement="bottom" title="Michael Zenaty"/>
                        </a>

                        <a href="javascript: void(0);" class="avatar-group-item">
                            <img src="{{ asset('storage/assets/images/users/avatar-8.jpg') }}"
                                 class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container1"
                                 data-bs-toggle="tooltip" data-bs-placement="bottom" title="James Anderson"/>
                        </a>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="card project-box">
                <div class="card-body">
                    ...
                    <div class="badge bg-soft-success text-success mb-3">Finished</div>
                    <!-- Desc-->
                    <p class="text-muted font-13 mb-3 sp-line-2">You need to be sure there isn't anything embarrassing
                        hidden in the middle of text...<a href="javascript:void(0);" class="fw-bold text-muted">view
                            more</a>
                    </p>
                    <!-- Task info-->
                    <p class="mb-1">
                    ...
                    <div class="avatar-group mb-3" id="tooltips-container2">
                        <a href="javascript: void(0);" class="avatar-group-item">
                            <img src="{{ asset('storage/assets/images/users/avatar-9.jpg') }}"
                                 class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container2"
                                 data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mat Helme"/>
                        </a>

                        <a href="javascript: void(0);" class="avatar-group-item">
                            <img src="{{ asset('storage/assets/images/users/avatar-10.jpg') }}"
                                 class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container2"
                                 data-bs-toggle="tooltip" data-bs-placement="bottom" title="Michael Zenaty"/>
                        </a>
            ...
            <div class="card project-box">
                <div class="card-body">
                    ...
                    <div class="avatar-group mb-3" id="tooltips-container3">
                        <a href="javascript: void(0);" class="avatar-group-item">
                            <img src="{{ asset('storage/assets/images/users/avatar-5.jpg') }}"
                                 class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container3"
                                 data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mat Helme"/>
                        </a>
        ...
        <div class="col-lg-4">
            <div class="card project-box">
                <div class="card-body">
                    ...
                    <div class="badge bg-soft-secondary text-secondary mb-3">Ongoing</div>
                    <!-- Desc-->
                    <p class="text-muted font-13 mb-3 sp-line-2">There are many variations of passages of Lorem Ipsum
                        available natural lead-in to additional...<a href="javascript:void(0);"
                    ...
                    <div class="avatar-group mb-3" id="tooltips-container4">
                        <a href="javascript: void(0);" class="avatar-group-item">
                            <img src="{{ asset('storage/assets/images/users/avatar-3.jpg') }}"
                                 class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container4"
                                 data-bs-toggle="tooltip" data-bs-placement="bottom" title="James Anderson"/>
                        </a>
            ...
            <div class="card project-box">
                <div class="card-body">
                    ...
                    <div class="avatar-group mb-3" id="tooltips-container5">
                        <a href="javascript: void(0);" class="avatar-group-item">
                            <img src="{{ asset('storage/assets/images/users/avatar-6.jpg') }}"
                                 class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container5"
                                 data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mat Helme"/>
                        </a>
