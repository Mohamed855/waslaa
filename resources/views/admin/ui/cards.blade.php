...
@section('dashboard-content')
    <div class="row">
        <div class="col-sm-6 col-lg-3">
            ...
            <div class="card d-block">
                <img class="card-img-top" src="{{ asset('storage/assets/images/small/small-1.png') }}"
                     alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card d-block">
                <img class="card-img-top" src="{{ asset('storage/assets/images/small/small-2.png') }}"
                     alt="Card image cap">
                <div class="card-body">
                    <h4 class="card-title">Card title</h4>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card d-block">
                <img class="card-img-top" src="{{ asset('storage/assets/images/small/small-3.png') }}"
                     alt="Card image cap">
                <div class="card-body">
                    <p class="card-text">Some quick example text to build on the card title and make
                        up the bulk of the card's content. Some quick example text to build on the card
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card d-block">
                ...
                <img class="img-fluid" src="{{ asset('storage/assets/images/small/small-4.png') }}"
                     alt="Card image cap">
                <div class="card-body">
                    <p class="card-text">Some quick example text to build on the card title and make
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-md-4">
                        <img src="{{ asset('storage/assets/images/small/small-1.png') }}" class="img-fluid rounded-end"
                             alt="...">
                    </div> <!-- end col -->
                </div> <!-- end row-->
            </div> <!-- end card -->
    ...
    <div class="row">
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <img src="{{ asset('storage/assets/images/small/small-2.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <img src="{{ asset('storage/assets/images/small/small-3.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <img src="{{ asset('storage/assets/images/small/small-4.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Card with stretched link</h5>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <img src="{{ asset('storage/assets/images/small/small-1.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
