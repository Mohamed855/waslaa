...
@section('additional-css')
    <!-- Plugin css -->
    <link rel="stylesheet" href="{{ asset('storage/assets/libs/jquery-toast-plugin/jquery.toast.min.css') }}">
@endsection
...
@section('dashboard-content')
                            ...
                            <div class="p-3">
                                ...
                                <div class="toast fade show" role="alert" aria-live="assertive"
                                    ...
                                    <div class="toast-header">
                                        <img src="{{ asset('storage/assets/images/logo-sm.png') }}" alt="brand-logo"
                                             height="16" class="me-1"/>
                                        <strong class="me-auto">TechUI</strong>
                                ...
                                <div aria-live="polite" aria-atomic="true"
                                    ...
                                    <div class="toast-container"
                                        ...
                                        <div class="toast fade show" role="alert" aria-live="assertive"
                                             aria-atomic="true">
                                            <div class="toast-header">
                                                <img src="{{ asset('storage/assets/images/logo-sm.png') }}"
                                                     alt="brand-logo"
                                                     height="16" class="me-1"/>
                                                <strong class="me-auto">TechUI</strong>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Jquery Toast</h4>
...
@section('additional-scripts')
    <script src="{{ asset('storage/assets/libs/jquery-toast-plugin/jquery.toast.min.js') }}"></script>
    <!-- Toastr Demo js -->
    <script src="{{ asset('storage/assets/js/pages/toasts.init.js') }}" type="module"></script>
@endsection
