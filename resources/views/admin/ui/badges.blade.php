            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">
                        A simple labeling component. Badges scale to match the size of the immediate parent element by
        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <span class="badge bg-blue-subtle text-blue">Blue</span>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Badge Positioned</h4>
                    <p class="text-muted mb-0">
