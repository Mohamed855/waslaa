...
@section('dashboard-content')
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-blue text-bg-blue border-0" role="alert">
                        <strong>Blue - </strong> A simple blue alert—check it out!
                    </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-blue bg-transparent text-blue" role="alert">
                        This is a <strong>Blue</strong> alert—check it out!
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-blue" role="alert">
                        A simple blue alert with <a href="#" class="alert-link">an example
                            link</a>. Give it a click if you like.
                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Icons with Alerts</h4>
                    <p class="text-muted mb-0">
                ...
                <div class="card-body">
                    <div class="alert alert-success" role="alert">
                        <i class="mdi mdi-check-bold me-1 align-middle fs-16"></i> This is a
                        <strong>success</strong> alert - check it out!
                    </div>
                    <div class="alert alert-danger" role="alert">
                        <i class="mdi mdi-close-circle-outline me-1 align-middle fs-16"></i> This is a
                        <strong>danger</strong>
                        alert - check it out!
                    </div>
                    <div class="alert alert-warning" role="alert">
                        <i class="mdi mdi-alert-outline me-1 align-middle fs-16"></i> This is a
                        <strong>warning</strong> alert - check it out!
                    </div>
                    <div class="alert alert-info mb-0" role="alert">
                        <i class="mdi mdi-alert-circle-outline me-1 align-middle fs-16"></i> This is a
                    ...
                    <div class="alert alert-info text-center mb-0" role="alert">
                        <div class="avatar-sm mb-2 mx-auto">
                            <span class="avatar-title bg-info rounded-circle">
                                <i class="mdi mdi-check-bold align-middle fs-22"></i>
                            </span>
                        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Click the button below to show an alert (hidden with inline styles to
