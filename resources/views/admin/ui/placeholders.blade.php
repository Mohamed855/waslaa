                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <div class="card border shadow-none mb-md-0">
                                <img src="{{ asset('storage/assets/images/small/small-1.png') }}" class="card-img-top"
                                     alt="...">
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">
                        By default, the <code>placeholder</code> uses <code>currentColor</code>. This
                        can be overriden with a custom color or utility class.
                    </p>
                </div>
                <div class="card-body">
                    ...
                    <span class="placeholder col-12 bg-blue"></span>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">
                        ...
                        parent element. Customize them with sizing modifiers:
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">
                        Create placeholders with the <code>.placeholder</code> class and a grid column
                        class (e.g., <code>.col-6</code>) to set the <code>width</code>. They can
                        replace the text inside an element or as be added as a modifier class to an
                        existing component.
                    </p>
                </div>
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary disabled placeholder col-4"
                       aria-hidden="true"></a>
                </div> <!-- end card-body-->
            </div> <!-- end card-->
        </div> <!-- end col-->
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">
                        ...
                        <code>.placeholder-wave</code> to better convey the perception of something
