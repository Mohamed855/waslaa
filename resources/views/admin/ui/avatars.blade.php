            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">
                        ...
                        Using Bootstrap's naming convention, you can control size of avatar including standard avatar,
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <img src="{{ asset('storage/assets/images/users/avatar-2.jpg') }}" alt="image"
                                 class="img-fluid avatar-xs rounded">
                            <p>
                                <code>.avatar-xs</code>
                            </p>
                            <img src="{{ asset('storage/assets/images/users/avatar-3.jpg') }}" alt="image"
                        ...
                        <div class="col-md-3">
                            <img src="{{ asset('storage/assets/images/users/avatar-4.jpg') }}" alt="image"
                        ...
                        <div class="col-md-3">
                            <img src="{{ asset('storage/assets/images/users/avatar-5.jpg') }}" alt="image"
                        ...
                        <div class="col-md-3">
                            <img src="{{ asset('storage/assets/images/users/avatar-6.jpg') }}" alt="image"
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <img src="{{ asset('storage/assets/images/users/avatar-7.jpg') }}" alt="image"
                        ...
                        <div class="col-md-4">
                            <img src="{{ asset('storage/assets/images/users/avatar-8.jpg') }}" alt="image"
                        ...
                        <div class="col-md-4">
                            <img src="{{ asset('storage/assets/images/users/avatar-9.jpg') }}" alt="image"
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-2">
                            <img src="{{ asset('storage/assets/images/small/small-2.png') }}" alt="image"
                        ...
                        <div class="col-sm-2">
                            <img src="{{ asset('storage/assets/images/small/small-3.png') }}" alt="image"
