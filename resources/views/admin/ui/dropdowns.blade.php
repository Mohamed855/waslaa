        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">The best part is you can do this with any button variant,
                        too:</p>
                </div>
                <div class="card-body">
                    ...
                    <div class="btn-group mb-2">
                        <button type="button" class="btn btn-light dropdown-toggle"
                                ...
                                aria-expanded="false">Secondary<i class="mdi mdi-menu-down"></i></button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">Action</a>
                            <a class="dropdown-item" href="#">Another action</a>
                            <a class="dropdown-item" href="#">Something else here</a>
                    ...
                    <div class="btn-group mb-2">
                        <button type="button" class="btn btn-success dropdown-toggle"
                                data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">Success<i class="mdi mdi-menu-down"></i></button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">Action</a>
                            <a class="dropdown-item" href="#">Another action</a>
                            <a class="dropdown-item" href="#">Something else here</a>
                    ...
                    <div class="btn-group mb-2">
                        <button type="button" class="btn btn-info dropdown-toggle"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Info<i
                    ...
                    <div class="btn-group mb-2">
                        <button type="button" class="btn btn-warning dropdown-toggle"
                                data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">Warning<i class="mdi mdi-menu-down"></i></button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">Action</a>
                            <a class="dropdown-item" href="#">Another action</a>
                            <a class="dropdown-item" href="#">Something else here</a>
                    ...
                    <div class="btn-group mb-2">
                        <button type="button" class="btn btn-danger dropdown-toggle"
                                data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">Danger<i class="mdi mdi-menu-down"></i></button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">Action</a>
                            <a class="dropdown-item" href="#">Another action</a>
                            <a class="dropdown-item" href="#">Something else here</a>
                    ...
                    <div class="btn-group mb-2">
                        <button type="button" class="btn btn-pink dropdown-toggle"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pink<i
                                class="mdi mdi-menu-down"></i></button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">Action</a>
                            <a class="dropdown-item" href="#">Another action</a>
                    ...
                    <div class="btn-group mb-2">
                        <button type="button" class="btn btn-blue dropdown-toggle"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Blue<i
                                class="mdi mdi-menu-down"></i></button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">Action</a>
                            <a class="dropdown-item" href="#">Another action</a>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Animated Dropdown</h4>
                    <p class="text-muted mb-0">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-group dropup">
                        <button type="button" class="btn btn-light dropdown-toggle"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropup
                            <i class="mdi mdi-menu-up"></i></button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">Action</a>
                            <a class="dropdown-item" href="#">Another action</a>
                            <a class="dropdown-item" href="#">Something else here</a>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Trigger dropdown menus at the right of the elements by
                        adding <code>.dropend</code> to the parent element.</p>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Add <code>.disabled</code> to items in the dropdown to
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Opt into darker dropdowns to match a dark navbar or
                        custom style by adding <code>.dropdown-menu-dark</code> onto an existing
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Use <code>data-bs-offset</code> or
                        <code>data-bs-reference</code> to change the location of the dropdown. </p>
                </div>
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <div class="btn-group">
                            ...
                            <button type="button"
                                    ...
                                    data-bs-toggle="dropdown" aria-expanded="false"
                                    data-bs-reference="parent"><i class="mdi mdi-menu-down"></i>
                                <span class="visually-hidden">Toggle Dropdown</span>
                            </button>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#">Action</a></li>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Place any freeform text within a dropdown menu with text
                        and use spacing utilities. Note that you'all likely need additional sizing
        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-group mb-2">
                        ...
                        <button type="button" class="btn btn-blue dropdown-toggle dropdown-toggle-split"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                                class="mdi mdi-menu-down"></i>
                            <span class="visually-hidden">Toggle Dropdown</span>
                        </button>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Button dropdowns work with buttons of all sizes,
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Trigger dropdown menus at the right of the elements by
                        adding <code>.dropleft</code> to the parent element.</p>
                </div>
                <div class="card-body">
                    ...
                    <div class="btn-group">
                        <div class="btn-group dropstart" role="group">
                            <button type="button"
                                    ...
                                    data-bs-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false"><span class="mdi mdi-menu-left"></span>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Add <code>.active</code> to item in the dropdown to
                        <strong>style them as active</strong>.</p>
                </div>
                <div class="card-body">
                    <!-- Active Item -->
                    <div class="btn-group">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Add a header to label sections of actions in any dropdown
                        menu</p>
                </div>
                <div class="card-body">
                    <!-- Header Item -->
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">By default, the dropdown menu is closed when clicking
                        inside or outside the dropdown menu. You can use the <code>autoClose</code>
                        option to change this behavior of the dropdown.</p>
                </div>
                <div class="card-body">
                    <div class="hstack gap-2">
                        <div class="btn-group">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Put a form within a dropdown menu, or make it into a
                        dropdown menu, and use margin or padding utilities to give it the negative space
                        you require.</p>
                </div>
                <div class="card-body">
                    <!-- Forms -->
