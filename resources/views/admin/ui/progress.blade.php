        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">A progress bar can be used to show a user how far along he/she is in a
                        process.</p>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">We only set a <code>height</code> value on the <code>.progress</code>, so
                        if you change that value the inner <code>.progress-bar</code> will automatically resize
                        accordingly.
                ...
                <div class="card-body">
                    ...
                    <div class="progress progress-xl">
                        <div class="progress-bar bg-success" role="progressbar" style="width: 38%" aria-valuenow="38"
                             aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div> <!-- end card-body -->
            </div> <!-- end card-->
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">The striped gradient can also be animated. Add <code>.progress-bar-animated</code>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Add labels to your progress bars by placing text within the <code>.progress-bar</code>.
                    </p>
                </div>
                <div class="card-body">
                    <div class="progress">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Use background utility classes to change the appearance of individual
                        progress bars.</p>
                </div>
                <div class="card-body">
                    <div class="progress mb-2">
                    ...
                    <div class="progress mb-2">
                        <div class="progress-bar bg-pink" role="progressbar" style="width: 85%" aria-valuenow="100"
                             aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress mb-2">
                        <div class="progress-bar bg-blue" role="progressbar" style="width: 85%" aria-valuenow="100"
                             aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress mb-2">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Add <code>.progress-bar-striped</code> to any <code>.progress-bar</code>
                        to apply a stripe via CSS gradient over the progress bar’s background color.</p>
                </div>
                <div class="card-body">
                    <div class="progress mb-2">
                    ...
                    <div class="progress">
                        <div class="progress-bar progress-bar-striped bg-pink" role="progressbar" style="width: 100%"
                             aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
