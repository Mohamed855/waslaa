        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">The collapse plugin also supports horizontal
                ...
                <div class="card-body">
                    ...
                    <div style="min-height: 112px;">
                        <div class="collapse collapse-horizontal" id="collapseWidthExample">
                            <div class="card card-body mb-0 bg-light" style="width: 300px;">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0"> Multiple <code>&lt;button&gt;</code> or <code>&lt;a&gt;</code> can show
                        and hide an element if they each reference it with their <code>href</code> or <code>data-bs-target</code>
                        attribute
                    </p>
                </div>
                <div class="card-body">
