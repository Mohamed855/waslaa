    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        <li class="list-group-item"><i class="mdi mdi-google-drive me-1"></i>
                            Google Drive
                        </li>
                        <li class="list-group-item"><i class="mdi mdi-facebook-messenger me-1"></i>
                            Facebook Messenger
                        </li>
                        <li class="list-group-item"><i class="mdi mdi-apple me-1"></i> Apple
                            Technology Company
                        </li>
                        <li class="list-group-item"><i class="mdi mdi-lifebuoy me-1"></i> Intercom
                            Support System
                        </li>
                        <li class="list-group-item"><i class="mdi mdi-alpha-p-circle-outline me-1"></i> Paypal
                            Payment Gateway
                        </li>
                    </ul>
                </div> <!-- end card-body -->
        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        <li class="list-group-item active"><i class="mdi mdi-google-drive me-1"></i> Google Drive</li>
                        <li class="list-group-item"><i class="mdi mdi-facebook-messenger me-1"></i>
                            Facebook Messenger
                        </li>
                        <li class="list-group-item"><i class="mdi mdi-apple me-1"></i> Apple
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="mb-0">Add <code>.disabled</code> to a <code>.list-group-item</code> to make it
                ...
                <div class="card-body">
                    <ul class="list-group">
                        <li class="list-group-item disabled" aria-disabled="true"><i
                                class="mdi mdi-google-drive me-1"></i> Google Drive
                        </li>
                        <li class="list-group-item"><i class="mdi mdi-facebook-messenger me-1"></i>
                            Facebook Messenger
                        </li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item list-group-item-blue">A simple blue list group item</li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="list-group">
                        ...
                        <a href="#" class="list-group-item list-group-item-action list-group-item-info">A simple info
                            list group item</a>
                        <a href="#" class="list-group-item list-group-item-action list-group-item-pink">A simple pink
                            list group item</a>
                        <a href="#" class="list-group-item list-group-item-action list-group-item-blue">A simple blue
                            list group item</a>
                        <a href="#" class="list-group-item list-group-item-action list-group-item-light">A simple light
                            list group item</a>
                        <a href="#" class="list-group-item list-group-item-action list-group-item-dark">A simple dark
                            list group item</a>
                    </div>
                </div> <!-- end card-body -->
            </div> <!-- end card-->
                    ...
                    <ol class="list-group list-group-numbered">
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <div class="fw-bold">TechUI Admin</div>
                                TechUI Admin
                            </div>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <div class="fw-bold">TechUI React Admin</div>
                                TechUI React Admin
                            </div>
