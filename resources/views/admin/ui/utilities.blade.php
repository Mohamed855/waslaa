...
@section('dashboard-content')
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Similar to the contextual text color classes, set the background of an
                ...
                <div class="card-body">
                    ...
                    <div class="bg-blue text-dark p-2 mb-2">.bg-blue</div>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Background Gradient Color</h4>
                    <p class="text-muted mb-0">By adding a <code>.bg-gradient</code> class, a linear gradient is added
                        as background image to the backgrounds. This
                ...
                <div class="card-body">
                    ...
                    <div class="p-2 mb-2 bg-blue bg-gradient text-dark">.bg-blue.bg-gradient</div>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Soft background</h4>
                    <p class="text-muted mb-0">Similar to the contextual text color classes, set the background of an
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="d-flex flex-column gap-2">
                                <div class="bg-primary-subtle p-2"><code class="text-primary-emphasis">.text-primary-subtle</code>
                                </div>
                                <div class="bg-secondary-subtle p-2"><code class="text-secondary-emphasis">.bg-secondary-subtle </code>
                                </div>
                                <div class="bg-success-subtle p-2"><code class="text-success-emphasis">.bg-success-subtle</code>
                                </div>
                                <div class="bg-danger-subtle p-2"><code
                                        class="text-danger-emphasis">.bg-danger-subtle</code></div>
                                <div class="bg-warning-subtle p-2"><code class="text-warning-emphasis">.bg-warning-subtle</code>
                                </div>
                                <div class="bg-info-subtle p-2"><code class="text-info-emphasis">.bg-info-subtle</code>
                                </div>
                                <div class="bg-pink-subtle p-2"><code class="text-pink-emphasis">.bg-pink-subtle</code>
                                </div>
                                <div class="bg-blue-subtle p-2"><code class="text-blue-emphasis">.bg-blue-subtle</code>
                                </div>
                                <div class="bg-light-subtle p-2"><code
                                        class="text-light-emphasis">.bg-light-subtle</code></div>
                                <div class="bg-dark-subtle p-2"><code class="text-dark-emphasis">.bg-dark-subtle</code>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Color and background helpers combine the power of our
                        <code>.text-*</code> utilities and <code>.bg-*</code> utilities in one class. Using our Sass
                        <code>color-co</code>
                </div>
                <div class="card-body">
                    ntrast()</code> function, we automatically determine a contrasting <code>color</code> for a
                    particular <code>background-color</code>.</p>
                    <div class="d-flex flex-column gap-2">
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0"><code>background-color</code> utilities are generated with Sass using CSS
                        variables. This
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Colorize text with color utilities. If you want to colorize links, you
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="text-blue-emphasis">.text-blue-emphasis</p>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">text color utilities are generated with Sass using CSS variables. This
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">The <code>opacity</code> property sets the opacity level for an element.
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <h4 class="card-title">Additive(Add) Border</h4>
                    <p class="text-muted mb-3">Use border utilities to <b>add</b> an element’s borders. Choose from all
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Subtractive(Remove) Border</h4>
                    <p class="text-muted mb-0">Use border utilities to <b>remove</b> an element’s borders. Choose from
    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Border Width Size</h4>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Border subtle Color</h4>
                    <p class="text-muted mb-0">Change the border color using utilities built on our theme colors.</p>
                </div>
                <div class="card-body">
                    <div class="d-flex align-items-start flex-wrap gap-2">
        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start flex-wrap gap-2">
                        <img src="{{ asset('storage/assets/images/users/avatar-2.jpg') }}" class="avatar-lg rounded"
                             alt="rounded">
                        <img src="{{ asset('storage/assets/images/users/avatar-2.jpg') }}" class="avatar-lg rounded-top"
                             alt="rounded-top">
                        <img src="{{ asset('storage/assets/images/users/avatar-2.jpg') }}" class="avatar-lg rounded-end"
                             alt="rounded-end">
                        <img src="{{ asset('storage/assets/images/users/avatar-2.jpg') }}"
                        ...
                        <img src="{{ asset('storage/assets/images/small/small-2.jpg') }}"
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Use the scaling classes for larger or smaller rounded corners. Sizes
                        range from <code>0</code> to <code>5</code>.</p>
                </div>
                <div class="card-body">
                    <div class="d-flex align-items-start flex-wrap gap-2">
                        <img src="{{ asset('storage/assets/images/users/avatar-4.jpg') }}" class="avatar-lg rounded-0"
                             alt="rounded-0">
                        <img src="{{ asset('storage/assets/images/users/avatar-4.jpg') }}" class="avatar-lg rounded-1"
                             alt="rounded-1">
                        <img src="{{ asset('storage/assets/images/users/avatar-4.jpg') }}" class="avatar-lg rounded-2"
                             alt="rounded-2">
                        <img src="{{ asset('storage/assets/images/users/avatar-4.jpg') }}" class="avatar-lg rounded-3"
                             alt="rounded-3">
                        <img src="{{ asset('storage/assets/images/users/avatar-4.jpg') }}" class="avatar-lg rounded-4"
                             alt="rounded-4">
                        <img src="{{ asset('storage/assets/images/users/avatar-4.jpg') }}" class="avatar-lg rounded-5"
                             alt="rounded-5">
                    </div>
                </div> <!-- end card-body -->
            </div> <!-- end card-->
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Bootstrap provides <code>.pe-none</code> and <code>.pe-auto</code>
                        classes to prevent or add element interactions.</p>
                </div>
                <div class="card-body">
                    <p><a href="#" class="pe-none" tabindex="-1" aria-disabled="true">This link</a> can not be clicked.
                    </p>
                    <p><a href="#" class="pe-auto">This link</a> can be clicked (this is default behavior).</p>
                    <p class="pe-none"><a href="#" tabindex="-1" aria-disabled="true">This link</a> can not be clicked
                        because the
                        <code>pointer-events</code> property is inherited from its parent. However, <a href="#"
                                                                                                       class="pe-auto">this
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Adjust the <code>overflow</code> property on the fly with four default
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Arrange elements easily with the edge positioning utilities. The format
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">In addition, you can also center the elements with the transform utility
                ...
                <div class="card-body">
                    ...
                    <div class="position-relative m-3 bg-light bg-opacity-50 border rounded" style="height: 180px;">
                        ...
                        <div
                            class="position-absolute top-50 start-100 translate-middle avatar-xs bg-dark rounded"></div>

                        <div class="position-absolute top-100 start-0 translate-middle avatar-xs bg-dark rounded"></div>
                        <div
                            class="position-absolute top-100 start-50 translate-middle avatar-xs bg-dark rounded"></div>
                        <div
                            class="position-absolute top-100 start-100 translate-middle avatar-xs bg-dark rounded"></div>
                    </div>
                </div> <!-- end card-body -->
            </div> <!-- end card-->
        </div> <!-- end col -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="position-relative m-3 bg-light border rounded" style="height: 180px;">
                        <div class="position-absolute top-0 start-0 avatar-xs bg-dark rounded "></div>
                        <div
                            class="position-absolute top-0 start-50 translate-middle-x avatar-xs bg-dark rounded"></div>
                        <div class="position-absolute top-0 end-0 avatar-xs bg-dark rounded"></div>

                        <div
                            class="position-absolute top-50 start-0 translate-middle-y avatar-xs bg-dark rounded"></div>
                        <div class="position-absolute top-50 start-50 translate-middle avatar-xs bg-dark rounded"></div>
                        <div class="position-absolute top-50 end-0 translate-middle-y avatar-xs bg-dark rounded"></div>

                        <div class="position-absolute bottom-0 start-0 avatar-xs bg-dark rounded"></div>
                        <div
                            class="position-absolute bottom-0 start-50 translate-middle-x avatar-xs bg-dark rounded"></div>
                        <div class="position-absolute bottom-0 end-0 avatar-xs bg-dark rounded"></div>
                    </div>
                </div> <!-- end card-body -->
            </div> <!-- end card-->
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">While shadows on components are disabled by default in Bootstrap and can
                        be enabled via
                        <code>$enable-shadows</code>, you can also quickly add or remove a shadow with our <code>box-shadow</code>
                        utility
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Width utilities are generated from the utility API in <code>_utilities.scss</code>.
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Height utilities are generated from the utility API in <code>_utilities.scss</code>.
                        Includes support for
                        <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, and <code>auto</code>
                        by default. Modify
                        those values as you need to generate different utilities here.
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Change the value of the <a
                        ...
                        tells the content to fill the parent container in a variety of ways, such as preserving the
                        aspect ratio or stretching to take up as much space as possible.</p>
                </div>
                <div class="card-body">

                    <div class="d-flex align-items-start flex-wrap gap-3 text-center">
                        <div>
                            <img src="{{ asset('storage/assets/images/small/small-1.jpg') }}"
