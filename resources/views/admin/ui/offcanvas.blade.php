            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">
                        ...
                        are visible. Use the <code>data-bs-scroll</code> attribute to toggle <code>&lt;body&gt;</code>
        ...
        <div class="col-xl-12">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button class="btn btn-primary mt-2 mt-lg-0" type="button" data-bs-toggle="offcanvas"
                                    data-bs-target="#offcanvasLeft" aria-controls="offcanvasLeft">Toggle Left offcanvas
                            </button>
                        </div> <!-- end d-flex flex-wrap gap-2-->
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Change the appearance of offcanvases with utilities to better match them
