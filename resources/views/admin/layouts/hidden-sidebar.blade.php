                    ...
                    <div class="bg-soft-primary rounded">
                        <div class="row text-center">
                            <div class="col-12 col-sm-6 col-md-3">
                                <p class="text-muted font-16 text-dark mt-3"><i class="fa-regular fa-circle-dot"></i>
                                    Current Week</p>
                                <h3 class="mb-3 mt-2">
                                    <span>$1705.54</span>
                                </h3>
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <p class="text-muted font-16 text-dark mt-3"><i class="fa-regular fa-circle-dot"></i>
                                    Previous Week</p>
                                <h3 class="mb-3 mt-2">
                                    <span>$6,523.25 <i class="fa-solid fa-arrow-turn-up"></i></span>
                                </h3>
                            </div>
                            <div class="col-12 col-sm-6 col-md-3">
                                <p class="text-muted font-16 text-dark mt-3"><i class="fa-regular fa-circle-dot"></i>
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <p class="text-muted font-16 text-dark mt-3"><i class="fa-regular fa-circle-dot"></i>
                                    Customers</p>
                                <h3 class="mb-3 mt-2">
                                    <span>69k<i class="fa-solid fa-arrow-turn-up"></i></span>
                                </h3>
                            </div>
                        </div>
                    </div>
