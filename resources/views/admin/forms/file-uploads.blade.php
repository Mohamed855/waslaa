...
@section('dashboard-content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Dropzone File Upload</h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Dropify File Upload</h4>
                    <p class="sub-header mb-0">
                        ...
                        <div class="col-lg-4">
                            <div class="mt-3">
                                <input type="file" data-plugins="dropify"
                                       data-default-file="{{ asset('storage/assets/images/small/small-2.png') }}"/>
...
@section('additional-scripts')
    <!-- Init js-->
    <script src="{{ asset('storage/assets/js/pages/form-fileuploads.init.js') }}" type="module"></script>
@endsection
