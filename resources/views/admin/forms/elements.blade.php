...
@section('dashboard-content')
                        ...
                        <div class="col-lg-6">
                            <form>
                                ...
                                <div>
                                    ...
                                    <input class="form-range" id="example-range" type="range" name="range" min="0"
                                           max="100">
                                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <h4 class="card-title mt-4">Switches</h4>
                            <p class="sub-header">
                        ...
                        <div class="col-md-6">
                            <h4 class="card-title mt-5 mt-sm-0">Checkboxes and radios</h4>
                            <div class="mt-3">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="sub-header mb-0">
                        ...
                        floating labels with Bootstrap’s textual form fields. A <code>placeholder</code> is
                        required on each <code>&lt;input&gt;</code> as our method of CSS-only floating
                        labels uses the <code>:placeholder-shown</code> pseudo-element. Also note that the
                        <code>&lt;input&gt;</code> must come first so we can utilize a sibling selector
                        (e.g., <code>~</code>).
                    </p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <h4 class="card-title mb-3">Floating Example</h4>
                        ...
                        <div class="col-lg-6">
                            <h4 class="card-title mt-lg-0 my-3">Selects</h4>
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <button
                                    class="btn input-group-text btn-primary waves-effect waves-light dropdown-toggle"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn input-group-text btn-dark waves-effect waves-light" type="button">
                                    Button
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="mb-3 mb-xl-0">
                                        <label for="inputGroupFile04" class="form-label">Default file
                                            input</label>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0 card-title">Basic Example</h4>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0 card-title">Horizontal form</h4>
                </div>
                <div class="card-body">
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="row mb-3">
                            <label for="inputPassword5" class="col-4 col-xl-3 col-form-label">Re
                                Password</label>
                            <div class="col-8 col-xl-9">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Column sizing</h4>
                </div>
                <div class="card-body">
                    ...
                    <form class="row g-3">
                        ...
                        <div class="col-xl-2 col-md-3">
                            <button type="submit" class="btn btn-primary waves-effect waves-light">Confirm
                                identity
                            </button>
                        </div>
                    </form>
                    ...
                    <form>
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <button type="submit" class="btn btn-primary waves-effect waves-light mb-2">Submit
                                </button>
                            </div>
                        </div>
                    </form>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted font-13 mb-0">More complex layouts can also be created with the grid
                        system.</p>
                </div>
                <div class="card-body">
                    <form>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <h4 class="card-title">Custom checkbox - Basic</h4>

                            <p class="sub-header">
                                Supports bootstrap brand colors: <code>.form-check</code>,
                                <code>.form-checkbox-*</code> etc.
                            </p>

                            <div class="form-check mb-2 form-checkbox-primary">
                            ...
                            <div class="form-check mb-2 form-checkbox-success">
                            ...
                            <div class="form-check mb-2 form-checkbox-danger">
                            ...
                            <div class="form-check mb-2 form-checkbox-warning">
                            ...
                            <div class="form-check mb-2 form-checkbox-pink">
                                <input class="form-check-input" type="checkbox" value="" id="customckeck5">
                                <label class="form-check-label" for="customckeck5">Pink</label>
                            </div>

                            <div class="form-check mb-2 form-checkbox-blue">
                                <input class="form-check-input" type="checkbox" value="" id="customckeck7" checked>
                                <label class="form-check-label" for="customckeck7">Blue</label>
                            </div>

                            <div class="form-check mb-2 form-checkbox-info">
                                <input class="form-check-input" type="checkbox" value="" id="customckeck8">
                                <label class="form-check-label" for="customckeck8">Info</label>
                            </div>

                            <div class="form-check mb-2 form-checkbox-dark">
                        ...
                        <div class="col-md-4">
                            <h4 class="card-title mt-3 mt-md-0">Custom checkbox - Circled</h4>
                            ...
                            <div class="form-check mb-2 form-checkbox-pink">
                                <input class="form-check-input rounded-circle" type="checkbox" value=""
                                       id="customckeck14" checked>
                                <label class="form-check-label" for="customckeck14">Pink</label>
                            </div>

                            <div class="form-check mb-2 form-checkbox-blue">
                                <input class="form-check-input rounded-circle" type="checkbox" value=""
                                       id="customckeck15" checked>
                                <label class="form-check-label" for="customckeck15">Blue</label>
                            </div>
                        ...
                        <div class="col-md-4">
                            <h4 class="card-title mt-3 mt-md-0">Custom checkbox - Disabled</h4>
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" value="" id="customckeck19" checked
                                       disabled>
                            ...
                            <div class="form-check mb-2 form-checkbox-warning">
                                <input class="form-check-input rounded-circle" type="checkbox" value=""
                                       id="customckeck20" checked disabled>
                                <label class="form-check-label" for="customckeck20">And this</label>
                            </div>

                            <div class="form-check mb-2 form-checkbox-info">
                                <input class="form-check-input" type="checkbox" value="" id="customckeck21" checked
                                       disabled>
                                <label class="form-check-label" for="customckeck21">Can't check this</label>
                            </div>

                            <div class="form-check mb-2 form-checkbox-pink">
                                <input class="form-check-input" type="checkbox" value="" id="customckeck22" checked
                                       disabled>
                            ...
                            <div class="form-check mb-2 form-checkbox-blue">
                                <input class="form-check-input rounded-circle" type="checkbox" value=""
                                       id="customckeck23" checked disabled>
                                <label class="form-check-label" for="customckeck23">And this</label>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Custom radio - Basic</h4>
                    <p class="sub-header mb-0">
                        Supports bootstrap brand colors: <code>.form-check</code>,
                        <code>.form-radio-*</code> etc.
                    </p>
                </div>
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-check mb-2 form-checkbox-warning">
                                        <input class="form-check-input" type="radio" name="flexRadioDefault"
                                               id="customradio5">
                                        <label class="form-check-label" for="customradio5">Warning</label>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-check mb-2 form-checkbox-warning">
                                        ...
                                        <label class="form-check-label" for="customradio13">Warning</label>
                                    </div>
                        ...
                        <div class="col-md-4">
                            <h4 class="card-title mt-3 mt-md-0">Custom radio - Disabled</h4>
                            <p class="sub-header">
                                Disabled state also supported.
                            </p>
