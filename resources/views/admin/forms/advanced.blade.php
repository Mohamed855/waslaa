...
@section('title', 'Advanced Plugins')

@section('additional-css')
    <!-- Plugins css -->
    <link href="{{ asset('storage/assets/libs/mohithg-switchery/switchery.min.css') }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ asset('storage/assets/libs/multiselect/css/multi-select.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('storage/assets/libs/select2/css/select2.min.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('storage/assets/libs/selectize/css/selectize.bootstrap3.css') }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ asset('storage/assets/libs/bootstrap-touchspin/jquery.bootstrap-touchspin.min.css') }}"
...
@section('dashboard-content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="sub-header mb-0">The jQuery replacement for select boxes</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control select2-multiple" data-toggle="select2" data-width="100%"
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="sub-header mb-0">Uses the HTML5 attribute "maxlength" to work.</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="sub-header mb-0">Example of multiple select.</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Auto Complete</h4>
                    <p class="sub-header mb-0">Ajax Autocomplete for jQuery allows you to easily create
...
@section('additional-scripts')
    ...
    <script src="{{ asset('storage/assets/libs/mohithg-switchery/switchery.min.js') }}"></script>
    <script src="{{ asset('storage/assets/libs/multiselect/js/jquery.multi-select.js') }}"></script>
    <script src="{{ asset('storage/assets/libs/select2/js/select2.min.js') }}"></script>
    <script src="{{ asset('storage/assets/libs/jquery-mockjax/jquery.mockjax.min.js') }}"></script>
    <script src="{{ asset('storage/assets/libs/devbridge-autocomplete/jquery.autocomplete.min.js') }}"></script>
    <script src="{{ asset('storage/assets/libs/bootstrap-touchspin/jquery.bootstrap-touchspin.min.js') }}"></script>
    <script src="{{ asset('storage/assets/libs/bootstrap-maxlength/bootstrap-maxlength.min.js') }}"></script>
    <!-- Init js-->
    <script src="{{ asset('storage/assets/js/pages/form-advanced.init.js') }}" type="module') }}"></script>
@endsection
