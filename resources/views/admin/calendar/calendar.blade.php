...
@section('additional-css')
    <!-- Plugin css -->
    <link href="{{ asset('storage/assets/libs/fullcalendar/main.min.css') }}" rel="stylesheet" type="text/css"/>
@endsection
                        ...
                        <div class="col-lg-3">
                            ...
                            <div id="external-events">
                                ...
                                <div class="external-event bg-success" data-class="bg-success">
                                    <i class="fa-solid fa-square-check me-2 vertical-middle"></i> New
                                    Theme Release
                                </div>
                                <div class="external-event bg-info" data-class="bg-info">
                                    <i class="fa-solid fa-square-check me-2 vertical-middle"></i> My
                                    Event
                                </div>
                                <div class="external-event bg-warning" data-class="bg-warning">
                                    <i class="fa-solid fa-square-check me-2 vertical-middle"></i> Meet
                                    manager
                                </div>
                                <div class="external-event bg-danger" data-class="bg-danger">
                                    <i class="fa-solid fa-square-check me-2 vertical-middle"></i> Create
                                    New theme
                                </div>
                            </div>
...
@section('additional-scripts')
    ...
    <script src="{{ asset('storage/assets/libs/fullcalendar/main.min.js') }}"></script>
    <!-- Calendar init -->
    <script src="{{ asset('storage/assets/js/pages/calendar.init.js') }}" type="module"></script>
@endsection
