...
@section('additional-css')
    <!-- Loading button css -->
    <link href="{{ asset('storage/assets/libs/ladda/ladda.min.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('storage/assets/libs/ladda/ladda-themeless.min.css') }}" rel="stylesheet" type="text/css"/>
@endsection
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="p-3">
                                <section class="progress-demo">
                                    ...
                                    <button class="ladda-button ladda-button-demo btn btn-success" dir="ltr"
...
@section('additional-scripts')
    <!-- Loading buttons js -->
    <script src="{{ asset('storage/assets/libs/ladda/spin.min.js') }}"></script>
    <script src="{{ asset('storage/assets/libs/ladda/ladda.min.js') }}"></script>
    <!-- Buttons init js-->
    <script src="{{ asset('storage/assets/js/pages/loading-btn.init.js') }}" type="module"></script>
@endsection
