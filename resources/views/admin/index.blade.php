            ...
            <div class="card bg-soft-primary">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div
                                class="d-flex align-items-center justify-content-center h-100 w-100 mt-4 mt-md-0">
                                <img alt="" class="img-fluid"
                                     src="{{ asset('storage/assets/images/hero-dashboard.png') }}">
                            </div>
                        </div><!-- end col -->
                    </div>
                </div> <!-- end card-body-->
    ...
    <div class="row">
        <div class="col-xl-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="apex-charts mb-1" data-colors="#3980c0, #0dcaf0" dir="ltr"
                         id="balance_overview"></div>

                    <div class="bg-soft-primary rounded">
                        <div class="row text-center">
                            <div class="col-12 col-sm-6 col-md-3">
                                <p class="text-muted font-16 text-dark mt-3"><i
                                        class="mdi mdi-circle-double"></i> Current Week</p>
                                <h3 class="mb-3 mt-2">
                                    <span>$1705.54</span>
                                </h3>
                            </div>
                            <div class="col-12 col-sm-6 col-md-3">
                                <p class="text-muted font-16 text-dark mt-3"><i
                                        class="mdi mdi-circle-double"></i> Previous Week</p>
                                <h3 class="mb-3 mt-2">
                                    <span>$6,523.25 <i
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <p class="text-muted font-16 text-dark mt-3"><i
                                        class="mdi mdi-circle-double"></i> Conversation</p>
                                <h3 class="mb-3 mt-2">
                                    <span>8.27%</span>
                                </h3>
                            </div>
                            <div class="col-12 col-sm-6 col-md-3">
                                <p class="text-muted font-16 text-dark mt-3"><i
                                        class="mdi mdi-circle-double"></i> Customers</p>
                                <h3 class="mb-3 mt-2">
                                    <span>69k <i
                    ...
                    <table
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="progress progress-sm">
                                    <div aria-label="Basic example" aria-valuemax="100"
                                         aria-valuemin="0"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="progress progress-sm">
                                    <div aria-label="Basic example" aria-valuemax="100"
                                         aria-valuemin="0" aria-valuenow="77"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="progress progress-sm">
                                    <div aria-label="Basic example" aria-valuemax="100"
                                         aria-valuemin="0" aria-valuenow="42"
                                         class="progress-bar bg-danger"
                                         role="progressbar" style="width: 42%">
                                    </div>
                                </div>
                            </td>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-borderless table-centered mb-0">
                        ...
                        <tr>
                            ...
                            <td>
                                <img alt="contact-img" class="rounded-circle float-start me-2"
                                     height="36"
                                     src="{{ asset('storage/assets/images/users/avatar-2.jpg') }}" title="contact-img"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <img alt="contact-img" class="rounded-circle float-start me-2"
                                     height="36"
                                     src="{{ asset('storage/assets/images/users/avatar-3.jpg') }}" title="contact-img"/>
                                <div class="overflow-hidden">
                        ...
                        <tr>
                            ...
                            <td>
                                <img alt="contact-img" class="rounded-circle float-start me-2"
                                     height="36"
                                     src="{{ asset('storage/assets/images/users/avatar-4.jpg') }}" title="contact-img"/>
                                <div class="overflow-hidden">
                        ...
                        <tr>
                            ...
                            <td>
                                <img alt="contact-img" class="rounded-circle float-start me-2"
                                     height="36"
                                     src="{{ asset('storage/assets/images/users/avatar-5.jpg') }}" title="contact-img"/>
                                <div class="overflow-hidden">
                        ...
                        <tr>
                            ...
                            <td>
                                <img alt="contact-img" class="rounded-circle float-start me-2"
                                     height="36"
                                     src="{{ asset('storage/assets/images/users/avatar-6.jpg') }}" title="contact-img"/>
                                <div class="overflow-hidden">
