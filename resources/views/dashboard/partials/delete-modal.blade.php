<button type="button" class="btn btn-danger ms-auto" data-bs-toggle="modal" data-bs-target="#deleteModal-{{ $resource . $single->id }}">
    <i data-feather="trash-2"></i>
    @lang('translate.delete')
</button>
<div class="modal fade" id="deleteModal-{{ $resource . $single->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
