        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item dropdown dropdown-notification me-25">
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                    ...
                    {{-- order number --}}
                    <li class="scrollable-container media-list" id="order_data"></li>
                    {{-- order number --}}
                    <li class="dropdown-menu-footer"><a class="btn btn-primary w-100" href="">@lang('translate.seeAllTheNotifications')</a></li>
                </ul>
            </li>
            {{-- ntf --}}
            {{--
            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
