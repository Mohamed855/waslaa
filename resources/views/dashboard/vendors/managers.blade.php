                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="position-relative">
                                            ...
                                            <input type="password" id="managerAddPassword" class="form-control" name="password" placeholder="@lang('translate.password')"/>
                                            <button class="btn btn-link position-absolute text-muted password-addon end-0" style="top:25px" type="button" onclick="toggleManagerAddPasswordVisibility()">
                                                <i id="managerAddEyeIcon" data-feather="eye"></i>
                                            </button>
                                        </div>
                                    </div>
                                    {{-- add avatar --}}
                                    <div class="col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="file" class="form-control" name="avatar" placeholder="@lang('translate.avatar')"/>
                                        </div>
                                    </div>
                                    <div class="col-12">
            ...
            <table id="example" class="table text-center table-bordered" style="width:100%">
                ...
                @foreach($selected['managers'] as $single)
                    <tr>
                        ...
                        <td>{{ $single->phone }}</td>
                        <td>
                            <form class="p-0 m-0" action="{{ route('activation.toggle', ['table' => 'manager', 'id' => $single->id]) }}" method="post">
                                @csrf
                                <label class="switch">
                        ...
                        <div class="modal fade modal-secondary text-start" id="EditManager" tabindex="-1" aria-labelledby="myModalLabel1660" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <section id="basic-vertical-layouts">
                                            <div class="row">
                                                <div class="col-md-12 col-12">
                                                    <form id="updateForm" class="form form-vertical" method="POST" enctype="multipart/form-data">
                                                        @csrf @method('PUT')
                                                        <div class="row">
                                                            {{-- edit name --}}
                                                            <div class="col-12">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="name">@lang('translate.name')</label>
                                                                    <input type="text" id="managerName" class="form-control" value="{{ $single->name }}" name="name" placeholder="@lang('translate.name')"/>
                                                                </div>
                                                            </div>
                                                            {{-- edit username --}}
                                                            <div class="col-12">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <input type="text" id="managerUsername" class="form-control" value="{{ $single->username }}" name="username" placeholder="@lang('translate.username')"/>
                                                                </div>
                                                            </div>
                                                            {{-- edit email --}}
                                                            <div class="col-12">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="email">@lang('translate.email')</label>
                                                                    <input type="email" id="managerEmail" class="form-control" value="{{ $single->email }}" name="email" placeholder="email@example.com"/>
                                                                </div>
                                                            </div>
                                                            {{-- edit phone --}}
                                                            <div class="col-12">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="phone">@lang('translate.phone')</label>
                                                                    <input type="text" id="managerPhone" class="form-control" value="{{ $single->phone }}" name="phone" onkeypress="return isNumberKey(event)" placeholder="01×××××××××"/>
                                                                </div>
                                                            </div>
                                                            {{-- edit password --}}
                                                            <div class="col-12">
                                                                <div class="mb-1 position-relative">
                                                                    ...
                                                                    <input type="password" id="managerEditPassword" class="form-control" name="password" placeholder="@lang('translate.password')"/>
                                                                    <button class="btn btn-link position-absolute text-muted password-addon end-0" style="top:25px" type="button" onclick="toggleManagerEditPasswordVisibility()">
                                                                        <i id="managerEditEyeIcon" data-feather="eye"></i>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                            {{-- edit avatar --}}
                                                            <div class="col-12">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="avatar">@lang('translate.avatar')</label>
                                                                    <input type="file" id="avatar" class="form-control" name="avatar" placeholder="@lang('translate.avatar')"/>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
