<div class="modal fade modal-secondary text-start" id="EditManager{{ $single->id }}" tabindex="-1" aria-labelledby="myModalLabel1660" aria-hidden="true">
                ...
                <section id="basic-vertical-layouts">
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <form id="updateManagerForm{{ $single->id }}" class="form form-vertical" method="POST" enctype="multipart/form-data">
                                @csrf @method('PUT')
                                <div class="row">
                                    {{-- edit name --}}
                            ...
                            @if ($single->avatar != null)
                                <div class="col-12">
                                    <form class="col-1 mt-1" action="{{ route('image.remove', ['id' => $single->id, 'table' => 'manager']) }}" method="POST">
                                        @csrf
