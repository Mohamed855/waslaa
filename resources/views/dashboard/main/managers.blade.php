                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        ...
                                        <form id="managersStore" class="form form-vertical"
                                            action="{{ route('managers.store') }} " method="POST"
                                            enctype="multipart/form-data">
                                            @csrf

                                            <div class="row">
                                                <input type="hidden" name="added_by" value="{{ auth('vendor')->id() }}">
                                                            ...
                                                            <form id="updateForm" class="form form-vertical"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <div class="mb-1">
                                                                            <label class="form-label"
                                                                                for="password">@lang('translate.password')
                                                                                (@lang('translate.enterPasswordToChange'))</label>
