...
@section('title', __('translate.components'))
@section('content')
    <div class="row">
                            ...
                            <section id="basic-vertical-layouts">
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        ...
                                        <form id="componentsStore" class="form form-vertical"
                ...
                <table id="example" class="table text-center table-bordered" style="width:100%">
                    ...
                    @foreach($data as $single)
                        <tr>
                            ...
                            <td>
                                <form class="p-0 m-0"
                                      action="{{ route('activation.toggle', ['table' => 'component', 'id' => $single->id]) }}"
                                      method="post">
                                    @csrf
                                    <label class="switch">
    ...
    <script>
        $(document).ready(function () {
            $('.typeBtn').on('click', function () {
                ...
                $('#name_en').val(component.name_en);
                $('#name_ar').val(component.name_ar);
                url = '{{ asset('') }}' + 'components/' + id
