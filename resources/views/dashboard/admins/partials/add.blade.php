<!-- Modal -->
<div class="modal fade modal-secondary text-start" id="AddAdmin" tabindex="-1" aria-labelledby="myModalLabel1660" aria-hidden="true">
                ...
                <section id="basic-vertical-layouts">
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <form id="adminsStore" class="form form-vertical" action="{{ route('admins.store') }} " method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    {{-- add name --}}
