<div class="modal fade modal-secondary text-start" id="EditComponent{{ $single->id }}" tabindex="-1" aria-labelledby="myModalLabel1660" aria-hidden="true">
                ...
                <section id="basic-vertical-layouts">
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <form id="updateComponentForm{{ $single->id }}" class="form form-vertical" method="POST">
                                @csrf @method('PUT')
                                <div class="row">
                                    {{-- edit en name --}}
