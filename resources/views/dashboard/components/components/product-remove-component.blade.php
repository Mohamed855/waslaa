    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="removeModalLabel">@lang('translate.remove') @lang('translate.component')</h5>
            ...
            <div class="modal-footer">
                ...
                <form class="d-inline" action="{{ route('removeProductComponent', ['id' => $single->id, 'productId' => $productId]) }}" method="POST">
                    @csrf @method('Delete')
