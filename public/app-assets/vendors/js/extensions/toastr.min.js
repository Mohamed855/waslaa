    ...
    a(["jquery"], function(a) {
        return (function() {
            ...
            function u(c) {
                ...
                function u() {
                    e.closeOnHover && j.hover(I, H), !e.onclick && e.tapToDismiss && j.click(G),
                        e.closeButton &&
                        n &&
                        n.click(function(a) {
                            a.stopPropagation ?
                ...
                if (
                    ("undefined" != typeof c.optionsOverride &&
                        ((e = a.extend(e, c.optionsOverride)),
                            (f = c.optionsOverride.iconClass || f)), !F(e, c))
                ) {
                    d++, (b = i(e, !0));
                    var h = null,
                        j = a("<div/>"),
